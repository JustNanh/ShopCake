...
export type Product = {
  ...
  price: number;
  image: string;
  category: "birthday" | "bread" | "pastry" | "cupcake" | "cookie";
...
export const categories = [
  ...
  { id: "pastry", name: "Bánh ngọt", image: pastry },
  { id: "cupcake", name: "Bánh cupcake", image: cakeTiramisu },
  { id: "cookie", name: "Bánh quy", image: cakeChocolate },
];
