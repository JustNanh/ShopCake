...
public class ProductsController : ControllerBase
{
    ...
    /// <summary>Lấy tất cả sản phẩm (kèm danh mục)</summary>
    [HttpGet]
    ...
    /// <summary>Thêm sản phẩm mới (cần đăng nhập)</summary>
    [HttpPost, Authorize]
    ...
    /// <summary>Cập nhật sản phẩm (cần đăng nhập)</summary>
    ...
    /// <summary>Xóa sản phẩm (cần đăng nhập)</summary>
